...
const locations = [
  "Zeus Power House, Brezinova 4690/144, 586 01 Jihlava",
...
const benefits: { title: string; description: string; icon: LucideIcon }[] = [
  {
    title: "Plan na miru",
    description: "Spolecne nastavime rozumny plan podle tvych cilů a casu, ktery vydrzi dlouhodobe.",
    icon: Target
  },
  {
    title: "Bezpecna technika",
    description: "Kazdy pohyb hlidam – od dechu po tempo – aby telo sililo bez zbytecne bolesti.",
    icon: ShieldCheck
  },
  {
    title: "Postupny progres",
    description: "Navazujeme na sebe, vidis realne zmeny ve sile, kondici i drzeni tela.",
    icon: TrendingUp
  }
];
        ...
        <div className="mx-auto max-w-4xl space-y-12">
          <div className="space-y-4 text-center sm:text-left">
            <span className="inline-flex items-center rounded-full bg-primary/10 px-4 py-1 text-sm font-medium uppercase tracking-wide text-primary">
              Individualni spoluprace 1:1
            </span>
            <h2 className="font-heading text-4xl font-bold uppercase leading-[1.05] text-foreground sm:text-5xl">
              Individualni treninky
            </h2>
            <p className="text-lg leading-relaxed text-gray-600">
              Hodina je jen o tobe. Nejdriv projdeme cile a omezeni, potom stavime cviceni do bloku tak, aby davalo hlavu i patu. Domu si odnasíš jasny plan, jak pokracovat mezi nasimi treninky.
            </p>
          </div>
          ...
          <div className="grid gap-6 rounded-3xl border border-gray-200 bg-white p-6 shadow-[var(--shadow-soft)] md:grid-cols-[minmax(0,0.55fr)_minmax(0,0.45fr)]">
            ...
            <div className="space-y-3 rounded-2xl bg-primary/5 p-5">
              ...
              <p className="text-sm text-gray-600">
                Spolecne nastavime rozsah a frekvenci tak, aby plan sedel tvemu casu i rozpoctu.
              </p>
              <p className="text-sm text-gray-600">
                Nabizim jednorazove konzultace, pravidelne 1:1 lekce i balicky s online podporou.
              </p>
            </div>
          </div>
