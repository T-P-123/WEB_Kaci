  ...
  const lessons = [
    {
      ...
      description: "Efektivní trénink zaměřený na posílení, mobilitu, stretching a ženskou energii.Efektivní trénink zaměřený na posílení, mobilitu, stretching a ženskou energii.Efektivní trénink zaměřený na posílení, mobilitu, stretching a ženskou energii.Efektivní trénink zaměřený na posílení, mobilitu, stretching a ženskou energii.",
    ...
    },
    {
      ...
      description: "Dynamický intervalový trénink pro zlepšení kondice, síly a spalování tuků.Dynamický intervalový trénink pro zlepšení kondice, síly a spalování tuků.Dynamický intervalový trénink pro zlepšení kondice, síly a spalování tuků.Dynamický intervalový trénink pro zlepšení kondice, síly a spalování tuků.",
    ...
    },
    {
      ...
      description:
        "Kombinace běhu a silových cviků inspirovaná závodním formátem Hyrox. Intenzivní trénink pro celé tělo a skvělá atmosféra!Kombinace běhu a silových cviků inspirovaná závodním formátem Hyrox. Intenzivní trénink pro celé tělo a skvělá atmosféra!Kombinace běhu a silových cviků inspirovaná závodním formátem Hyrox. Intenzivní trénink pro celé tělo a skvělá atmosféra!Kombinace běhu a silových cviků inspirovaná závodním formátem Hyrox. Intenzivní trénink pro celé tělo a skvělá atmosféra!",
    ...
    },
    {
      ...
      description: "Jemnější lekce pro tělo i mysl – protažení, mobilita a posílení středu těla.Jemnější lekce pro tělo i mysl – protažení, mobilita a posílení středu těla.Jemnější lekce pro tělo i mysl – protažení, mobilita a posílení středu těla.Jemnější lekce pro tělo i mysl – protažení, mobilita a posílení středu těla.",
