  ...
  const lessons = [
    {
      ...
      shortTitle: "HEAT",
      description: "Vysoce intenzivní intervalový trénink, který kombinuje praktické cviky a pomáhá zlepšit kondici, sílu i vytrvalost. Efektivní forma cvičení vhodná pro každého, kdo se chce cítit silněji a mít více energie do běžného života.",
      benefits: [
    ...
    },
    {
      ...
      title: "REPS & RUN",
      shortTitle: "REPS & RUN",
      description: "Kombinace běhu a silově-kondičních bloků. Přesně ten typ tréninku, kde se spálí kalorie, zvýší tep a posouvají limity. Skvělé pro ty, kdo milují výzvy a týmovou atmosféru.",
      whatToExpect: "Výpady, veslo, wall balls, ropes, angličáky a další funkční cviky. Připraveno tak, aby to byla zábava i pořádná dřina.",
      benefits: [
      ...
      schedule: "každé úterý a pátek 16:00",
      price: "190 Kč",
    ...
    },
    {
      ...
      description: "Uvolňovací a posilovací trénink pro zdravé a funkční tělo. Vhodné pro každého, kdo chce zlepšit flexibilitu, odstranit ztuhlost a posílit střed těla.",
      whatToExpect: [
      ...
      <div className="container mx-auto px-4">
        ...
        <div className="space-y-16 max-w-7xl mx-auto">
          {lessons.map((lesson, index) => (
            <div key={lesson.id} className={`grid lg:grid-cols-2 gap-12 items-center ${index % 2 === 1 ? 'lg:grid-flow-col-dense' : ''}`}>
