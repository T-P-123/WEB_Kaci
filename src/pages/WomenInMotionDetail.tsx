        ...
        <div className="container mx-auto px-4 py-12">
          ...
          <div className="text-center mb-12">
            ...
            <div className="bg-pink-100 p-4 rounded-lg inline-block mb-6">
              <p className="text-lg font-medium text-pink-900 mb-1">"pojďme vrátit pohyb do vesnic"</p>
            </div>
            <div className="mb-6">
              <p className="text-lg font-semibold text-gray-800 mb-1">📍 Místo konání</p>
              <p className="text-gray-700">Obrataň – tělocvična (Sportovní hala, Obrataň 163, 394 12 Obrataň)</p>
            </div>
            <div className="text-4xl font-bold text-primary mb-4">130 Kč / lekce</div>
          ...
          <div className="max-w-4xl mx-auto space-y-8">
            ...
            <Card>
              <CardContent className="p-8">
                <p className="text-lg text-gray-700 leading-relaxed text-center">
                  Přijď si užít hodinu pohybu, která ti dodá sílu a dobrou náladu. Chci ti pomoci rozhýbat tělo a načerpat novou energii – hodinu jen pro tebe, bez tlaku na výkon, jednoduchým cvičením a v partě žen, které se vzájemně podporují.
                </p>
              </CardContent>
            </Card>
                ...
                <div className="space-y-4">
                  <div className="flex gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-gray-700">Příjemný začátek, kdy tělo nastartuje</p>
                    </div>
                  </div>
                  <div className="flex gap-4">
                  ...
                  <div className="flex gap-4">
                    ...
                    <div>
                      <h4 className="font-semibold">Kondiční část</h4>
                      <p className="text-gray-700">Krátký blok, kde se trochu zadýcháš a zlepšíš kondici (s možností lehčí i náročnější varianty)</p>
                    </div>
                  </div>
                  <div className="flex gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-gray-700">Na závěr může přijít něco navíc, co nás propojí – ať už krátká výzva, nebo třeba společné sdílení</p>
                    </div>
                  </div>
                  <div className="flex gap-4">
              ...
              <CardContent className="p-8">
                ...
                <div className="bg-yellow-50 p-6 rounded-lg text-center">
                  <p className="text-lg font-medium text-yellow-800">
                    👉 Na lekci se rozhýbeš, posílíš celé tělo, zlepšíš kondici a odcházíš s úsměvem a energií do dalších dní. 💪✨
                  </p>
                </div>
              </CardContent>
            </Card>
            ...
            <Card>
              <CardContent className="p-8">
                ...
                <div className="mt-6 p-4 bg-green-50 rounded-lg">
                  ...
                  <p className="text-green-700">Obrataň – tělocvična (Sportovní hala, Obrataň 163, 394 12 Obrataň)</p>
                </div>
              </CardContent>
            </Card>
            ...
            <div className="text-center py-8">
              ...
              <div className="mt-4 text-center text-sm text-muted-foreground">
                <p>Nebo napiš přímo na: <a href="mailto:katarina.lapackova@seznam.cz?subject=Rezervace%20-%20Ženy%20v%20pohybu" className="text-primary hover:underline">katarina.lapackova@seznam.cz</a></p>
              </div>
            </div>
          </div>
        </div>
