                ...
                <div className="space-y-4">
                  ...
                  <div className="flex gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-gray-700">Střídání vysoké intenzity (30-45 sekund) s aktivním odpočinkem (15-30 sekund)</p>
                    </div>
                  </div>
                  <div className="flex gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-gray-700">Uvolnění svalů, zklidnění tepu a mentální uklidnění</p>
                    </div>
                  </div>
                </div>
              </CardContent>
              ...
              <CardContent className="p-8">
                ...
                <div className="bg-yellow-50 p-4 rounded-lg">
                  ...
                  <ul className="space-y-1 text-yellow-700">
                    <li>• Ručník - potíš se hodně, ale odměnou je skvělý pocit</li>
                  ...
                  <div className="space-y-4">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-gray-600">Každou neděli 09:00</p>
                      </div>
                    </div>
                    <div className="flex items-center gap-3">
